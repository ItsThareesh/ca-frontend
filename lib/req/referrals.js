 ...
 * not something this site can build. That is a provider limitation, not a
 * missing fetch here.
 *
 ...
 * The backend normally issues it when the profile is completed; this covers
 * the CAs for whom that did not happen.
 */
